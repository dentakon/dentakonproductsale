...
<form name="transfer" id="transfer" action="[{$oViewConf->getSelfLink()}]" method="post">
    ...
    <input type="hidden" name="cl" value="actions_main_longdesc">
</form>
    ...
    [{if $edit->oxactions__oxtype->value > 0}]
       ...
       [{if $edit->oxactions__oxtype->value == 3}]
        ...
        <td valign="top" class="edittext" align="left" style="width:100%;padding-left:5px;padding-bottom:10px;">
            <table cellspacing="0" cellpadding="0" border="0">
                [{if $edit->oxactions__oxtype->value == 2 || $edit->oxactions__oxtype->value == 1 }]
                ...
                <tr>
                    <td class="edittext">
                        ...
                        <input type="button" value="[{oxmultilang ident="GENERAL_ASSIGNARTICLE"}]" class="edittext" onclick="JavaScript:showDialog('&cl=actions_main_longdesc&oxpromotionaoc=article&oxid=[{$oxid}]');" [{$readonly}]>
